...
public class Start {
    ...
    public void Find() {
        ...
        WebElement element1 = wd.findElements(By.tagName("a"));
        WebElement element2 = wd.findElement(By.tagName("div"));
        WebElement element3 = wd.findElement(By.id("skip-to-content"));
        WebElement element4 = wd.findElement(By.className("visually-hidden"));
        WebElement element5 = wd.findElement(By.linkText("Log in"));
